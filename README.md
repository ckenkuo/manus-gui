...
> **manus-gui** — a personal derivative work based on [OpenManus](https://github.com/FoundationAgents/OpenManus) by [@FoundationAgents](https://github.com/FoundationAgents) (manna_and_poem et al.), released under the MIT License. All credit for the original framework goes to the upstream authors.
